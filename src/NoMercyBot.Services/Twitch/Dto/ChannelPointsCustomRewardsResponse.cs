...
{
    [JsonProperty("data")]
    public List<ChannelPointsCustomRewardsResponseData> Data { get; set; }
}
...
public class ChannelPointsCustomRewardsResponseData
{
    ...
    [JsonProperty("image")]
    public ChannelPointsCustomRewardsResponseDefaultImage Image { get; set; }
    ...
    public ChannelPointsCustomRewardsResponseDefaultImage DefaultImage { get; set; }
